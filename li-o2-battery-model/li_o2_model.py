...
for j in range(N_y_ca):
    ...
    plt.figure(1)
    plt.plot(SV.t,SV.y[SVptr['phi_dl'][j],:],label=j+1)
    plt.xlabel('Time (s)')
    ...
    plt.figure(2)
    plt.plot(SV.t,SV.y[SVptr['eps_oxide'][j],:],label=j+1)
    plt.xlabel('Time (s)')
    ...
    plt.figure(3)
    plt.plot(SV.t, SV.y[SVptr['C_k_elyte_ca'][j][pltptr['Li+']],:],label=j+1)
    plt.xlabel('Time (s)')
    ...
    plt.figure(4)
    plt.plot(SV.t, SV.y[SVptr['C_k_elyte_ca'][j][pltptr['O2']],:], label=j+1)
    plt.xlabel('Time (s)')
    ...
    plt.plot(SV.t, A_carb, label=j+1)
    plt.xlabel('Time (s)')
    plt.ylabel('Available surface area per unit volume.')
    plt.tight_layout()
    plt.legend()
    """plt.figure(6)
    plt.plot(SV.t,SV.y[SVptr['C_k_elyte_ca'][0][pltptr['EC']]+SV_move,:],label=j+1)
    plt.xlabel('Time (s)')
    ...
    plt.figure(7)
    plt.plot(SV.t,SV.y[SVptr['C_k_elyte_ca'][0][pltptr['EMC']]+SV_move,:],label=j+1)
    plt.xlabel('Time (s)')
    plt.ylabel('EMC Concentration (kg/m3)')
    plt.tight_layout()
    plt.legend()"""

Nplot = np.linspace(1,N_y_sep,N_y_sep)

"""for i in range(len(Nplot)):
    SV_move = i * len(SV_single_sep)

    plt.figure(8)
    plt.plot(SV.t,SV.y[SVptr['sep_phi']+SV_move,:],label=j+1)
    plt.xlabel('Time (s)')
    ...
    plt.figure(9)
    plt.plot(SV.t,SV.y[SVptr['sep_elyte'][pltptr['Li+']]+SV_move,:],label=j+1)
    plt.xlabel('Time (s)')
    ...
    plt.figure(10)
    plt.plot(SV.t,SV.y[SVptr['sep_elyte'][pltptr['O2']]+SV_move,:],label=j+1)
    plt.xlabel('Time (s)')
    plt.ylabel('O2 Concentration - separator (kg/m3)')
    plt.legend()

    plt.figure(11)
    plt.plot(SV.t,SV.y[SVptr['sep_elyte'][pltptr['PF6-']]+SV_move,:],label=j+1)
    plt.xlabel('Time (s)')
    ...
    plt.figure(12)
    plt.plot(SV.t,SV.y[SVptr['sep_elyte'][pltptr['EC']]+SV_move,:],label=j+1)
    plt.xlabel('Time (s)')
    ...
    plt.figure(13)
    plt.plot(SV.t,SV.y[SVptr['sep_elyte'][pltptr['EMC']]+SV_move,:],label=j+1)
    plt.xlabel('Time (s)')
